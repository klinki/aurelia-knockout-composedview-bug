...
au.PLATFORM.Loader = (function () {
  ...
  TextTemplateLoader.prototype.loadTemplate = function loadTemplate(
    loader,
    entry
  ) {
    ...
    _this.addPlugin("template-registry-entry", {
      fetch: function fetch(address) {
        ...
        return entry.templateIsLoaded
          ? entry
          : _this.templateLoader.loadTemplate(_this, entry).then(function (x) {
              return entry;
            });
      }
    });
  ...
  InlineScriptDefaultLoader.prototype.useTemplateLoader = function useTemplateLoader(
    templateLoader
  ) {
    this.templateLoader = templateLoader;
  };

  InlineScriptDefaultLoader.prototype.loadAllModules = function loadAllModules(
    ids
  ) {
    var loads = [];
  ...
  InlineScriptDefaultLoader.prototype.loadTemplate = function loadTemplate(
    url
  ) {
  ...
  InlineScriptDefaultLoader.prototype.loadText = function loadText(url) {
    return this._import(this.applyPluginToUrl(url, this.textPluginName)).then(
      function (textOrModule) {
  ...
  if (typeof _aureliaPal.PLATFORM.global.requirejs.s === "object") {
    ...
    typeof _aureliaPal.PLATFORM.global.requirejs.contexts === "object"
  ) {
    getDefined = function getDefined() {
      return _aureliaPal.PLATFORM.global.requirejs.contexts._.defined;
    };
  } else if (
    typeof _aureliaPal.PLATFORM.global.requirejs.definedValues === "function"
  ) {
    getDefined = function getDefined() {
  ...
  InlineScriptDefaultLoader.prototype.loadModule = function (id) {
    ...
    return new Promise(function (resolve, reject) {
      _aureliaPal.PLATFORM.global.require(
        [id],
        function (m) {
  ...
  InlineScriptDefaultLoader.prototype.normalize = function (
    moduleId,
    relativeTo
  ) {
  ...
  InlineScriptDefaultLoader.prototype.normalizeSync = function (
    moduleId,
    relativeTo
  ) {
    return moduleId;
  ...
  InlineScriptDefaultLoader.prototype.applyPluginToUrl = function (
    url,
    pluginName
  ) {
  ...
  InlineScriptDefaultLoader.prototype.addPlugin = function (
    pluginName,
    implementation
  ) {
   ...
   */
  InlineScriptDefaultLoader.prototype.getOrCreateTemplateRegistryEntry = function (
    address
  ) {
    return (
      this.templateRegistry[address] ||
      (this.templateRegistry[address] = new au.TemplateRegistryEntry(address))
    );
  };
