define(["require", "exports", "aurelia-pal", "aurelia-knockout/knockout-bindable", "aurelia-knockout/knockout-composition", "aurelia-knockout/knockout-custom-attribute", 
    "aurelia-knockout/require-polyfill", "aurelia-knockout/knockout-custom-attribute", "aurelia-knockout/knockout-composition", "aurelia-knockout/require-polyfill"], function (require, exports, aurelia_pal_1, knockout_bindable_1, knockout_composition_1, knockout_custom_attribute_1, require_polyfill_1, knockout_custom_attribute_2, knockout_composition_2, require_polyfill_2) {
    "use strict";
    function __export(m) {
    ...
    function configure(frameworkConfig) {
        ...
        frameworkConfig.globalResources(aurelia_pal_1.PLATFORM.moduleName('aurelia-knockout/knockout-custom-attribute'));
