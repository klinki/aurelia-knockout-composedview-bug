...
define(["require", "exports", "knockout", "aurelia-dependency-injection", "aurelia-loader", "aurelia-templating"], function (require, exports, ko, aurelia_dependency_injection_1, aurelia_loader_1, aurelia_templating_1) {
    ...
    function recursiveKoUnwrap(object) {
        return ko.unwrap(object);

        if (typeof object !== "function") {
            return object;
        }

        var res = ko.unwrap(object);

        Object.keys(res).forEach(property => {
            res[property] = recursiveKoUnwrap(object[property]);
        });
    ...
    function processInstruction(instruction) {
        ...
        instruction.overrideContext = {
            bindingContext: null,
            parentOverrideContext: instruction.$parent
        };

        instruction.viewSlot.overrideContext = instruction.$parent;
        if (instruction.viewSlot.bindingContext == null) {
            instruction.viewSlot.bindingContext = instruction.$parent;
        }
    ...
    var KnockoutComposition = /** @class */ (function () {
        ...
        KnockoutComposition.prototype.register = function () {
            ...
            ko.bindingHandlers.compose = {
                update: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
                    ...
                    doComposition.call(_this, element, recursiveKoUnwrap(value), viewModel);
                }
            };
        ...
        KnockoutComposition.prototype.buildCompositionSettings = function (value, bindingContext) {
            ...
            var settings = { view: view, viewModel: viewModel, model: activationData, $parent: bindingContext };
